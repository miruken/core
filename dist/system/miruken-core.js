...
System.register(["reflect-metadata"], function (_export, _context) {
    ...
    function $using(disposing, action, context) {
        if (disposing && $isFunction$1(disposing.dispose)) {
            if (!$isPromise(action)) {
                var result = void 0;
                try {
                    result = $isFunction$1(action) ? action.call(context, disposing) : action;
                    if (!$isPromise(result)) {
                        return result;
                    }
                } finally {
    ...
    function _preOrder(node, visitor, context) {
        ...
        if ($isFunction$1(node.traverse)) node.traverse(function (child) {
    ...
    function _levelOrder(node, visitor, context) {
        ...
        while (queue.length > 0) {
            ...
            if ($isFunction$1(next.traverse)) next.traverse(function (child) {
        ...
        execute: function () {
            ...
            _export("Protocol", Protocol = Base.extend((_Base$extend = {
                ...
                isAdoptedBy: function isAdoptedBy(target) {
                    ...
                    var metaTarget = $isFunction$1(target) ? target.prototype : target;
            ...
            DesignMetadata = Metadata.extend(null, {
                get: function get(metadataKey, target, targetKey) {
            ...
            _export("design", design = DesignMetadata.decorator(designMetadataKey, function (target, key, descriptor, types) {
                if (!isDescriptor(descriptor)) {
            ...
            _export("$isFunction", $isFunction$1);
