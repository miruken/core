...
System.register(["./base2"], function (_export2, _context) {
    ...
    return {
        setters: [function (_base) {
            ...
            for (var _key3 in _base) {
                if (_key3 !== "default") _exportObj[_key3] = _base[_key3];
            }
        ...
        execute: function () {
            ...
            _export2("Miruken", Miruken = Base.extend(null, {
                coerce: function coerce() {
